...
public class LinkedList<T> {
	...
	/**
	 * This constructor initialises the list with values provided by the user.
	 *
	 * Uses varargs.
	 *
	...
	/**
	 * Adds a new node on a certian index of the list.
	 *
	 * Nodes are moved 1 space to the bottom of the list in order to make
	...
	private boolean indexExists_aux(int pIndex){
		return (this.size > pIndex && pIndex >= 0);
	}
